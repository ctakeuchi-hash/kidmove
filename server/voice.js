...
export const THEMES = ['space', 'ocean', 'forest', 'candy']
const noArgs = { type: 'object', properties: {}, additionalProperties: false }
const TOOLS = [
  { name: 'change_theme', description: 'Change the background theme of the game.', strict: true,
    input_schema: { type: 'object', properties: { theme: { type: 'string', enum: THEMES } }, required: ['theme'], additionalProperties: false } },
